...
const Textone = (
  <div>
        <Typography variant="h6" align="center" style={{ marginTop: 30, marginBottom:30 }}>
...
export default function ElevateAppBar(props) {
  ...
  return (
    <div className={classes.SelfText}>
      ...
      <div>
        {mediaquary ? Textone:<Typography variant="h6" align="center" className={classes.Selftexttwo}>
          Stories by Viswachand Reddy is recognized as one of the world's finest
          wedding photography firms. We create <br/> exquisite visual stories rooted
          in heart, rooted in emotion, rooted in the story of the moment.
        </Typography> }
